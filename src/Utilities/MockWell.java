...
public class MockWell {

    private static Inventory inv;

    private static MapLocation loc;

    private static ResourceType type;

    private static boolean isUpgraded;

    public MockWell(MapLocation loc, ResourceType type){
        inv = new Inventory();
        this.loc = loc;
        this.type = type;
    }

    public MockWell(MapLocation loc, ResourceType type, Inventory inv){
        this.inv = inv;
        this.loc = loc;
        this.type = type;
    }
    ...
    public MockWell copy(){
        Inventory newInv = this.inv.copy();
        MockWell newWell = new MockWell(this.loc, this.type, newInv);
        return newWell;
    }
